...
import javax.swing.*;
public class TempCoversion extends JFrame{
	//create components
	...
	public TempCoversion() {
		...
		FahrHandler fahrHandler = new FahrHandler();
		fahrenheitTF.addActionListener(fahrHandler);
	...
	public static void main(String[] args) {
		...
		TempCoversion tempConv = new TempCoversion();
	}
